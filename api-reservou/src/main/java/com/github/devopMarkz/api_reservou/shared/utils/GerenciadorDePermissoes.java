package com.github.devopMarkz.api_reservou.shared.utils;

public class GerenciadorDePermissoes {

    public static final String ROLE_USUARIO_COMUM = "hasAnyRole('ROLE_USUARIO_COMUM', 'ROLE_ADMINISTRADOR', 'ROLE_DONO')";
